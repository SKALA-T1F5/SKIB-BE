...
public class AuthUserController {
    ...
    @SwaggerApiSuccess(summary = "유저 로그인", description = "이메일과 비밀번호를 JSON 형태로 Body에 담아 요청하면 JWT 토큰이 발급됩니다.")
    ...
    @SwaggerApiSuccess(summary = "유저 로그아웃", description = "Authorization 헤더에 JWT 토큰을 담아 요청하면 로그아웃 처리됩니다.")
    @SwaggerApiNotFoundError
    @SwaggerInternetServerError
    @PostMapping("/logout")
